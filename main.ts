namespace SpriteKind {
    export const home_kind = SpriteKind.create()
    export const hero_kind = SpriteKind.create()
    export const door_kind = SpriteKind.create()
}
sprites.onOverlap(SpriteKind.hero_kind, SpriteKind.door_kind, function (sprite, otherSprite) {
    sprites.destroyAllSpritesOfKind(SpriteKind.home_kind)
    sprites.destroyAllSpritesOfKind(SpriteKind.door_kind)
    sprite.setPosition(75, 104)
...
function fnc_home () {
    home = sprites.create(img`
        ...
        `, SpriteKind.home_kind)
    home.setPosition(120, 50)
    door = sprites.create(img`
        ...
        6f4e44e44e44e44ee6
        6e4e44e44e44e44ee6
        `, SpriteKind.door_kind)
    door.setPosition(home.x, home.bottom - 9)
}
function fnc_hero () {
